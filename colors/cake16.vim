...
" ANSI 3  (normal yellow)    #c79747
" ANSI 4  (normal blue)      #678797
" ANSI 5  (normal magenta)   #878787
" ANSI 6  (normal cyan)      #308090
" ANSI 7  (normal white)     #ede4d4
" ANSI 8  (bright black)     #774f38
" ANSI 9  (bright red)       #f10000
" ANSI 10 (bright green)     #8fb1c0
" ANSI 11 (bright yellow)    #e4dccc
" ANSI 12 (bright blue)      #aaccdc
" ANSI 13 (bright magenta)   #afafaf
" ANSI 14 (bright cyan)      #6cb7c7
...
hi Comment      guifg=#878787   guibg=NONE      ctermfg=5      ctermbg=NONE      gui=none      cterm=none
...
hi MatchParen   guifg=fg        guibg=#aaccdc   ctermfg=fg     ctermbg=12        gui=none      cterm=none
hi NonText      guifg=#878787   guibg=NONE      ctermfg=5      ctermbg=NONE      gui=none      cterm=none
hi SpecialKey   guifg=#878787   guibg=NONE      ctermfg=5      ctermbg=NONE      gui=none      cterm=none
...
hi CursorColumn guifg=NONE      guibg=#e4dccc   ctermfg=NONE   ctermbg=11        gui=none      cterm=none
hi CursorLine   guifg=NONE      guibg=#e4dccc   ctermfg=NONE   ctermbg=11        gui=none      cterm=none
hi Visual       guifg=bg        guibg=#8fb1c0   ctermfg=bg     ctermbg=10        gui=none      cterm=none
hi VisualNOS    guifg=NONE      guibg=NONE      ctermfg=NONE   ctermbg=NONE      gui=underline cterm=underline
hi IncSearch    guifg=bg        guibg=#6cb7c7   ctermfg=bg     ctermbg=14        gui=none      cterm=none
hi Search       guifg=bg        guibg=#c79747   ctermfg=bg     ctermbg=3         gui=none      cterm=none

" UI
hi LineNr       guifg=#afafaf   guibg=#ede4d4   ctermfg=13     ctermbg=7         gui=none      cterm=none
hi CursorLineNr guifg=fg        guibg=#e4dccc   ctermfg=fg     ctermbg=11        gui=none      cterm=none
hi Pmenu        guifg=bg        guibg=#678797   ctermfg=bg     ctermbg=4         gui=none      cterm=none
hi PmenuSel     guifg=fg        guibg=#aaccdc   ctermfg=fg     ctermbg=12        gui=none      cterm=none
hi PMenuSbar    guifg=bg        guibg=fg        ctermfg=bg     ctermbg=fg        gui=none      cterm=none
hi PMenuThumb   guifg=fg        guibg=#aaccdc   ctermfg=fg     ctermbg=12        gui=none      cterm=none
hi StatusLine   guifg=bg        guibg=#678797   ctermfg=bg     ctermbg=4         gui=none      cterm=none
hi StatusLineNC guifg=bg        guibg=#aaccdc   ctermfg=bg     ctermbg=12        gui=none      cterm=none
hi TabLine      guifg=bg        guibg=#678797   ctermfg=bg     ctermbg=4         gui=none      cterm=none
hi TabLineFill  guifg=bg        guibg=#678797   ctermfg=bg     ctermbg=4         gui=none      cterm=none
hi TabLineSel   guifg=fg        guibg=#ede4d4   ctermfg=fg     ctermbg=7         gui=none      cterm=none
hi VertSplit    guifg=fg        guibg=#678797   ctermfg=fg     ctermbg=4         gui=none      cterm=none
hi Folded       guifg=#878787   guibg=NONE      ctermfg=5      ctermbg=NONE      gui=none      cterm=none
hi FoldColumn   guifg=#878787   guibg=NONE      ctermfg=5      ctermbg=NONE      gui=none      cterm=none
...
hi DiffChange   guifg=bg        guibg=#c79747   ctermfg=bg     ctermbg=3         gui=none      cterm=none
hi DiffDelete   guifg=bg        guibg=#b95942   ctermfg=bg     ctermbg=1         gui=none      cterm=none
hi DiffText     guifg=bg        guibg=#c79747   ctermfg=bg     ctermbg=3         gui=none      cterm=none
...
hi MoreMsg      guifg=#878787   guibg=NONE      ctermfg=5      ctermbg=NONE      gui=none      cterm=none
...
hi WildMenu     guifg=NONE      guibg=#678797   ctermfg=NONE   ctermbg=4         gui=none      cterm=none
